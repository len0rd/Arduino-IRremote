...
#		if SEND_RC5
			...
			uint16_t encodeRC5(uint8_t address, uint8_t command, bool key_released);
#		endif
#		if SEND_RC5X
		void sendRC5x(unsigned char key_released, unsigned char system, unsigned char command, unsigned char extension);
#		endif
#		if SEND_RC6
